...
/*   Updated: 2024/11/11 15:50:14 by nmattos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap_bonus.h"

static char	*concatenate_buffer(char *line, char *buffer, size_t *size)
{
	size_t	length;
	size_t	i;
	size_t	j;
...
static char	*fill_vault(char *vault, char *buffer)
{
	size_t	i;
...
static char	*read_next(int fd, char *line, char **vault)
{
	char	*buffer;
	ssize_t	bytes_read;
	size_t	size;
...
static char	*init_strings(char **vault)
{
	char	*line;
	size_t	size;
